...
/**
 * Test for /order/checkTrans
 */
Test('/order/checkTrans', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test checkTrans get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/order/checkTrans']['get']['responses']['200']['schema']);
